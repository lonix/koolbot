...
// Escaping helpers live in `html.ts` so the admin and user renderers share
// one implementation; re-exported here for the existing call sites (#851).
export { escapeHtml, escapeJsInAttr };
